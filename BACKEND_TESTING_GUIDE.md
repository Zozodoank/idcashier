...
curl -X POST \
  https://eypfeiqtvfxxiimhtycc.supabase.co/functions/v1/auth-login \
...
curl -X GET \
  https://eypfeiqtvfxxiimhtycc.supabase.co/functions/v1/products-get-all \
  -H "Authorization: Bearer YOUR_JWT_TOKEN"

# Test products-create function
curl -X POST \
  https://eypfeiqtvfxxiimhtycc.supabase.co/functions/v1/products-create \
  -H "Authorization: Bearer YOUR_JWT_TOKEN" \
  -H "Content-Type: application/json" \
  -d '{
    "name": "Test Product",
