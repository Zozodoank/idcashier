  ...
  useEffect(() => {
    ...
    const styles = {
      ...
      'delivery-note': `
        ...
        @media print {
          body[data-print-type="delivery-note"] * {
            visibility: hidden;
          }

          body[data-print-type="delivery-note"] [role="dialog"],
          body[data-print-type="delivery-note"] [role="dialog"] * {
            visibility: visible;
          }
          ...
          body[data-print-type="delivery-note"] .printable-invoice-area,
          body[data-print-type="delivery-note"] .printable-invoice-area * {
            visibility: visible;
          }

          body[data-print-type="delivery-note"] .invoice-container {
            width: 21cm !important;
            min-height: 29.7cm !important;
            padding-top: 25mm !important;
            padding-bottom: 25mm !important;
          ...
          body[data-print-type="delivery-note"] .invoice-container table th,
          body[data-print-type="delivery-note"] .invoice-container table td {
            padding: 8px !important;
            font-size: 13px !important;
          }

          body[data-print-type="delivery-note"] .invoice-container h1,
          body[data-print-type="delivery-note"] .invoice-container h2 {
            font-size: 18px !important;
          }
        }
      `,
