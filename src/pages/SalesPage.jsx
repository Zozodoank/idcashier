          ...
          <Card className="flex-1 flex flex-col">
            ...
            <CardContent className="border-t pt-4 space-y-3">
              ...
              <div className="flex items-center">
                ...
                <Input id="payment" type="number" placeholder={t('paymentAmountPlaceholder')} value={paymentAmount || ''} onChange={e => setPaymentAmount(Number(e.target.value))} className="flex-1" />
