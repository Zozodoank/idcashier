...
async function testUserFetch() {
  console.log('=== Testing User Fetch Function ===');
  ...
  try {
    ...
    // 2. Test the user fetch function
    console.log('2. Testing user fetch function...');
    const response = await fetch('https://eypfeiqtvfxxiimhtycc.supabase.co/functions/v1/test-user-fetch', {
      method: 'POST',
      headers: {
